...
;
USER_MODE		EQU		0x10					;
FIQ_MODE        EQU     0x11                    ; Disable IRQ/FIQ FIQ mode
IRQ_MODE        EQU     0x12                    ; Disable IRQ/FIQ IRQ mode
SVC_MODE        EQU     0x13                    ; Disable IRQ/FIQ SVC mode
ABORT_MODE		EQU		0x17					;
UNDEF_MODE		EQU		0x1B					;

SYS_MODE        EQU     0x1F                    ; Disable IRQ/FIQ SYS mode
...
;
    ...
    IMPORT      _tx_thread_vectored_context_save
...
;
    LDR     r1, =__heap_limit                   ; Get end of non-initialized RAM area
...
;
    EXPORT  __tx_sunxi_vectored_irq_handler
__tx_sunxi_vectored_irq_handler
;
;
